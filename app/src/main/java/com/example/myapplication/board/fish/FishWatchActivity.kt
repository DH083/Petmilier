...
import com.example.myapplication.databinding.ActivityFishWatchBinding
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.ValueEventListener

class FishWatchActivity : AppCompatActivity() {

    private lateinit var binding: ActivityFishWatchBinding
    private lateinit var key: String
    private var Tag = ActivityFishWatchBinding::class.java
    private val commentDataList = mutableListOf<commentModel>()
    private lateinit var commentAdapter: CommentLVAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_fish_watch)

        key = intent.getStringExtra("key").toString()
        getFishData(key.toString())
    ...
    private fun showDialog() {
        ...
        alertDialog.findViewById<Button>(R.id.delete)?.setOnClickListener {
            FBRef.fishRef.child(key).removeValue()
        ...
        alertDialog.findViewById<Button>(R.id.cancel)?.setOnClickListener {
            val intent = Intent(this, FishEditActivity::class.java)
