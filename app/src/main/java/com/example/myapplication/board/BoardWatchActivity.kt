...
import com.example.myapplication.databinding.ActivityBoardWatchBinding
...
import kotlinx.android.synthetic.main.activity_board_watch.*

class BoardWatchActivity : AppCompatActivity() {

    private lateinit var binding : ActivityBoardWatchBinding

    private lateinit var key: String

    private var Tag = ActivityBoardWatchBinding::class.java
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_board_watch)
