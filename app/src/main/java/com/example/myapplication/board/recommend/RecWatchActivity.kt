...
import com.example.myapplication.databinding.ActivityRecWatchBinding
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.ValueEventListener

class RecWatchActivity : AppCompatActivity() {

    private lateinit var binding: ActivityRecWatchBinding
    private lateinit var key: String
    private var Tag = ActivityRecWatchBinding::class.java
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_rec_watch)

        key = intent.getStringExtra("key").toString()
        getRecData(key.toString())
    ...
    private fun showDialog() {
        ...
        alertDialog.findViewById<Button>(R.id.delete)?.setOnClickListener {
            FBRef.RecRef.child(key).removeValue()
        ...
        alertDialog.findViewById<Button>(R.id.cancel)?.setOnClickListener {
            val intent = Intent(this, RecEditActivity::class.java)
    ...
    private fun getRecData(key: String) {
        val postListener = object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
        ...
        FBRef.RecRef.child(key).addValueEventListener(postListener)
    }
