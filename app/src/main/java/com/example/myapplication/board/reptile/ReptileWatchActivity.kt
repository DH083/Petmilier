...
import com.example.myapplication.databinding.ActivityReptileWatchBinding
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.ValueEventListener

class ReptileWatchActivity : AppCompatActivity() {

    private lateinit var binding: ActivityReptileWatchBinding
    private lateinit var key: String
    private var Tag = ActivityReptileWatchBinding::class.java
    private val commentDataList = mutableListOf<commentModel>()
    private lateinit var commentAdapter: CommentLVAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_reptile_watch)

        key = intent.getStringExtra("key").toString()
        getRepData(key.toString())
    ...
    private fun showDialog() {
        ...
        alertDialog.findViewById<Button>(R.id.delete)?.setOnClickListener {
            FBRef.ReptileRef.child(key).removeValue()
        ...
        alertDialog.findViewById<Button>(R.id.cancel)?.setOnClickListener {
            val intent = Intent(this, ReptileEditActivity::class.java)
