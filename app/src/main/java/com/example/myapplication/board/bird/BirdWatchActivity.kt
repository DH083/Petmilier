...
class BirdWatchActivity : AppCompatActivity() {

    private lateinit var binding: ActivityBirdWatchBinding
    private lateinit var key: String
    private var Tag = ActivityBirdWatchBinding::class.java
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_bird_watch)

        key = intent.getStringExtra("key").toString()
        getBirdData(key.toString())
    ...
    private fun showDialog() {
        ...
        alertDialog.findViewById<Button>(R.id.delete)?.setOnClickListener {
            FBRef.birldRef.child(key).removeValue()
        ...
        alertDialog.findViewById<Button>(R.id.cancel)?.setOnClickListener {
            val intent = Intent(this, BirdEditActivity::class.java)
