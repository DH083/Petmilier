...
class CatwatchActivity : AppCompatActivity() {

    private lateinit var binding: ActivityCatwatchBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_catwatch)

        key = intent.getStringExtra("key").toString()
        getCatData(key.toString())
    ...
    private fun showDialog() {
        ...
        alertDialog.findViewById<Button>(R.id.delete)?.setOnClickListener {
            FBRef.catRef.child(key).removeValue()
        ...
        alertDialog.findViewById<Button>(R.id.cancel)?.setOnClickListener {
            val intent = Intent(this, CatEditActivity::class.java)
