...
import com.example.myapplication.databinding.ActivityRabbitWatchBinding
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.ValueEventListener

class RabbitWatchActivity : AppCompatActivity() {
    private lateinit var binding: ActivityRabbitWatchBinding
    private lateinit var key: String
    private var Tag = ActivityRabbitWatchBinding::class.java
    private val commentDataList = mutableListOf<commentModel>()
    private lateinit var commentAdapter: CommentLVAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_rabbit_watch)

        key = intent.getStringExtra("key").toString()
        getRabData(key.toString())
    ...
    private fun showDialog() {
        ...
        alertDialog.findViewById<Button>(R.id.delete)?.setOnClickListener {
            FBRef.rabbitRef.child(key).removeValue()
        ...
        alertDialog.findViewById<Button>(R.id.cancel)?.setOnClickListener {
            val intent = Intent(this, RabbitEditActivity::class.java)
