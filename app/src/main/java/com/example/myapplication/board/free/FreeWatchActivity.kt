...
import com.example.myapplication.databinding.ActivityFreeWatchBinding
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.ValueEventListener

class FreeWatchActivity : AppCompatActivity() {

    private lateinit var binding: ActivityFreeWatchBinding
    private lateinit var key: String
    private var Tag = ActivityFreeWatchBinding::class.java
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_free_watch)

        key = intent.getStringExtra("key").toString()
        getFreeData(key.toString())
    ...
    private fun showDialog() {
        ...
        alertDialog.findViewById<Button>(R.id.delete)?.setOnClickListener {
            FBRef.freeRef.child(key).removeValue()
        ...
        alertDialog.findViewById<Button>(R.id.cancel)?.setOnClickListener {
            val intent = Intent(this, FreeEditActivity::class.java)
