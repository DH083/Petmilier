...
import com.example.myapplication.board.DogEditActivity
...
import com.example.myapplication.databinding.ActivityCatwatchBinding
import com.example.myapplication.databinding.ActivityDogWatchBinding
...
class DogWatchActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityDogWatchBinding
    private lateinit var key: String
    private var Tag = ActivityCatwatchBinding::class.java
    private val commentDataList = mutableListOf<commentModel>()
    private lateinit var commentAdapter: CommentLVAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_dog_watch)

        key = intent.getStringExtra("key").toString()
        getDogData(key.toString())
    ...
    private fun showDialog() {
        ...
        alertDialog.findViewById<Button>(R.id.cancel)?.setOnClickListener {
            val intent = Intent(this, DogEditActivity::class.java)
    ...
    private fun getDogData(key: String) {
        val postListener = object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                try {
